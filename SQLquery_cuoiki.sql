...
BEGIN
    SET NOCOUNT ON;
    SELECT maSP, tenSP, donGiaBan, soLuongHienCon, DMno, linkAnh FROM SanPham;
END;
GO
...
INSERT INTO SanPham (maSP, tenSP, donGiaBan, soLuongHienCon, DMno, linkAnh)
VALUES 
    ('SP00001', N'Cà phê sữa đá', 25000, 100, 'DM00001', 'images/cafe_sua_da.jpg'),
    ('SP00002', N'Trà sữa trân châu', 35000, 80, 'DM00001', 'images/tra_sua.jpg'),
    ('SP00003', N'Bánh mì pate', 20000, 50, 'DM00002', 'images/banh_mi.jpg'),
    ('SP00004', N'Khoai tây chiên', 30000, 60, 'DM00003', 'images/khoai_tay.jpg');
GO
