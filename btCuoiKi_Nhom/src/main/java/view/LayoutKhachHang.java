...
public class LayoutKhachHang extends javax.swing.JFrame {
    ...
    public LayoutKhachHang() {
        ...
        controllerKhachHang khEvent = new controllerKhachHang(this);
        this.btn_KhachHang_Resert.addActionListener(khEvent);
        this.btn_KhachHang_TimKiem.addActionListener(khEvent);
        this.btn_KhachHang_Xoa.addActionListener(khEvent);
        this.btn_KhachHang_Sua.addActionListener(khEvent);
    }
    
    public  void loadKhachHangData() {
        try {
            DefaultTableModel model = (DefaultTableModel) this.tb_KhachHang.getModel()  ;
        
            model.setRowCount(0);
            for(modelKhachHang kh : khManager.getKhachHangs()){
                model.addRow(new Object[]{kh.getMaKH() , kh.getTenKH() , kh.getSdt() , kh.getEmail() , kh.getSoDu() , kh.getDiaChi() , kh.getGioiTinh()});
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    private void initComponents() {
                ...
                .addGroup(jPanel11Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel11Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel11Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(txt_KhachHang_tenKhachHang, javax.swing.GroupLayout.DEFAULT_SIZE, 147, Short.MAX_VALUE)
        ...
        jPanel11Layout.setVerticalGroup(
            ...
            .addGroup(jPanel11Layout.createSequentialGroup()
                .addGroup(jPanel11Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(panel_timKiem, javax.swing.GroupLayout.PREFERRED_SIZE, 169, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGroup(jPanel11Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(jPanel11Layout.createSequentialGroup()
                            .addGroup(jPanel11Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                .addGroup(jPanel11Layout.createSequentialGroup()
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                    .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(LayoutKhachHang, javax.swing.GroupLayout.PREFERRED_SIZE, 587, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))
        );
    ...
    public void searchKhachHang(){
        DefaultTableModel model = (DefaultTableModel) this.tb_KhachHang.getModel()  ;
        String tenKh = this.txt_KhachHang_TimKiemTen.getText().trim();
        try {
            ArrayList<modelKhachHang> list =  khManager.search(tenKh);
            model.setRowCount(0);
            
            if(list.isEmpty()){
                JOptionPane.showMessageDialog(null, "Không tìm thầy tên khách hàng");
            }else{
    ...
    private void tb_KhachHangMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tb_KhachHangMousePressed
        int selected = this.tb_KhachHang.getSelectedRow();
        
        if(selected != -1 ){
            txt_KhachHang_maKhachHang.setText(this.tb_KhachHang.getValueAt(selected, 0).toString());
            txt_KhachHang_tenKhachHang.setText(this.tb_KhachHang.getValueAt(selected, 1).toString());
            txt_KhachHang_SDT.setText(this.tb_KhachHang.getValueAt(selected, 2).toString());
            txt_KhachHang_Email.setText(this.tb_KhachHang.getValueAt(selected, 3).toString());
            txt_KhachHang_soDuTaiKhoan.setText(this.tb_KhachHang.getValueAt(selected, 4).toString());
            txt_KhachHang_DiaChi.setText(this.tb_KhachHang.getValueAt(selected, 5).toString());
            
            String gioiTinh = this.tb_KhachHang.getValueAt(selected, 6).toString();
            setgioiTinh(gioiTinh);
        }
    }//GEN-LAST:event_tb_KhachHangMousePressed
    ...
    public javax.swing.JRadioButton RadioKhac;
    ...
    public javax.swing.JTextField txt_KhachHang_DiaChi;
    public javax.swing.JTextField txt_KhachHang_Email;
    public javax.swing.JTextField txt_KhachHang_SDT;
    public javax.swing.JTextField txt_KhachHang_TimKiemTen;
    public javax.swing.JTextField txt_KhachHang_maKhachHang;
    public javax.swing.JTextField txt_KhachHang_soDuTaiKhoan;
    public javax.swing.JTextField txt_KhachHang_tenKhachHang;
